...
def get_route(hostname):
    ...
    for ttl in range(1,MAX_HOPS):
        for tries in range(TRIES):
            destAddr = gethostbyname(hostname) #gets the IP address
            #Fill in start
            ...
            try:
                ...
                rtt = int((timeReceived - startedSelect) * 1000) #round trip time
                rtt = str(rtt) + "ms"
                ...
                if types == 11:
                    ...
                    type_msg = "Request timed out"
                    tracelist2.append(ttl)
                    tracelist2.append("*")
                    tracelist2.append(type_msg)
                    #Fill in end
                elif types == 3:
                    bytes = struct.calcsize("d")
